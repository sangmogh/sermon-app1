...
function GraceNoteCard({
  ...
  const timeLabel = note.start_time || "듣기";
      ...
      {youtubeHref ? (
        <div className="mt-5 flex justify-end">
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-full bg-indigo-100 px-3.5 py-1.5 text-xs font-semibold text-indigo-800 transition-colors hover:bg-indigo-200/90 active:scale-95"
            aria-label={`${timeLabel}부터 유튜브에서 듣기`}
          >
